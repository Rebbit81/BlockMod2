...
public class ModBlocks {
    ...
    public static void init() {
        ...
        Registry.register(Registry.ITEM, new Identifier("blockmod", "palladium_block"), new BlockItem(PALLADIUM_BLOCK, new FabricItemSettings().group(Blockmod.BM_GROUP.MISC)));
        Registry.register(Registry.BLOCK, new Identifier("blockmod", "palladium_ore_block"), PALLADIUM_ORE_BLOCK);
        Registry.register(Registry.ITEM, new Identifier("blockmod", "palladium_ore_block"), new BlockItem(PALLADIUM_ORE_BLOCK, new FabricItemSettings().group(Blockmod.BM_GROUP.MISC)));
    }
}
